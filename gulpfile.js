...
gulp.task('fileinclude', () => {
  return gulp.src([src_folder + '**/*.html'], { since: gulp.lastRun('fileinclude')})
  .pipe(fileinclude({
    prefix: '@@',
    basepath: '@file'
  }))
...
gulp.task('build', gulp.series('clear', 'html', 'fileinclude', 'sass', 'js', 'images', 'vendor'));

gulp.task('dev', gulp.series('html', 'fileinclude', 'sass', 'js'));
